# Assinatura e direitos autorais — Primeiro Formulário -SCTEC

Este repositório integra o ecossistema da **Jus 9 Tecnologia Jurídica**.

**Software livre com autoria preservada.** A licença livre permite uso, estudo,
modificação e distribuição nos termos da licença aplicável, mas não remove a
autoria, a origem, a assinatura institucional nem os direitos autorais.
